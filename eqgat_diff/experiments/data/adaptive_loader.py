...
class AdaptiveCollater:
    ...
    def __call__(self, batch):
        ...
        if isinstance(elem, BaseData):
            ...
            max_size = max(
                max_size, 9
            )  # The batch sizes may be huge if the graphs happen to be tiny
            ...
            new_batch = Batch.from_data_list(
                to_keep, self.follow_batch, self.exclude_keys
            )
            return new_batch
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            collate_fn=AdaptiveCollater(
                follow_batch, exclude_keys, reference_batch_size=reference_batch_size
            ),
            **kwargs,
        )
...
class AdaptiveLightningDataset(LightningDataset):
    ...
    def dataloader(
        self, dataset: Dataset, shuffle: bool = False, **kwargs
    ) -> AdaptiveDataLoader:
